...
class ManagerSubsystem(Subsystem):
    ...
    async def create_session(
        ...
        """
        Request shell session with remote entity.

        Requires:
            - authenticated console
            - active tunnel
            - destination entity UID
    ...
    async def request_tunnel(
        ...
        self.core.runtime.set_tunnel(
            tunnel_token=tunnel_data.get(
                "tunnel_token"
            ),

            tunnel_host=tunnel_data.get(
                "host"
            ),

            tunnel_port=tunnel_data.get(
                "port"
            )
        )
